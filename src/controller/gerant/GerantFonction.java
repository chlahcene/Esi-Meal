...
public class GerantFonction {
    ...
    public void modifierClique(){
        ...
        Parent root ;
        try {
            root = FXMLLoader.load(getClass().getResource("/view/ModifierMenu.fxml"));
    ...
    public void nombreCmdEff() {
        ...
        if (date1.getValue()==null|| date2.getValue()==null) {
            erreurdate.setText("veiller remplir les dates");
            erreurdate.setVisible(true);
        } else {
            erreurdate.setText("il n y a aucune commande effectué !");
